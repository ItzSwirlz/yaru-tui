# Ubuntu community theme "yaru". Better than a burrito. (MATE variant)
...
# UI
set-face global Default "rgb:%opt{jet},rgb:%opt{white}"
...
set-face global LineNumbers "rgb:%opt{jet},rgb:%opt{silk}+b"
set-face global Whitespace "rgb:%opt{graphite},rgb:%opt{white}"
...
set-face global meta "rgb:%opt{black}+b"
set-face global operator "rgb:%opt{black}+b"
...
# Annotations
set-face global Error "rgb:%opt{red},rgb:%opt{porcelain}+bu"
set-face global DiagnosticError "rgb:%opt{red},rgb:%opt{porcelain}+bu"
set-face global DiagnosticWarning "rgb:%opt{orange},rgb:%opt{porcelain}+bu"
