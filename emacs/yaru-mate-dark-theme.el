;;; yaru-mate-dark-theme.el --- Yaru-MATE-Dark Emacs theme from the Ubuntu Community  -*- lexical-binding:t -*-
...
(deftheme yaru-mate-dark
  "Ubuntu community theme. Better than a burrito. (MATE Dark variant)")
...
(provide-theme 'yaru-mate-dark)

;;; yaru-mate-dark-theme.el ends here