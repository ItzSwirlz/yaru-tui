;;; yaru-theme.el --- Yaru Emacs theme from the Ubuntu Community  -*- lexical-binding:t -*-
...
(deftheme yaru
  "Ubuntu community theme. Better than a burrito.")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'yaru
   ;; UI
   `(default ((,class (:foreground ,jet :background ,white))))
   ...
   `(line-number-current-line ((,class (:background ,silk))))
   `(line-number ((,class (:foreground ,jet :background ,silk :weight bold))))
   `(match ((,class (:foreground ,white :background ,green))))
   `(show-paren-match ((,class (:foreground ,green :background ,porcelain))))
   `(show-paren-match-expression ((,class (:foreground ,green :background ,porcelain))))
   `(show-paren-mismatch ((,class (:foreground ,red :background ,porcelain))))
   `(trailing-whitespace ((,class (:foreground ,graphite :background ,porcelain))))
   `(isearch ((,class (:foreground ,white :background ,green))))
   `(isearch-fail ((,class (:foreground ,white :background ,red))))
   ;; Emacs Specific
   `(border ((,class (:background ,silk))))
   `(internal-border ((,class (:background ,silk))))
   ...
   `(link ((,class (:foreground ,black :underline t))))
   `(custom-link ((,class (:foreground ,black :underline t))))
   ...
   `(font-lock-preprocessor-face ((,class (:foreground ,black :weight bold))))
   `(variable-pitch ((,class (:foreground ,black :weight bold))))
   ...
   ;; Annotations
   `(error ((,class (:foreground ,red :background ,porcelain :weight bold :underline t))))
   `(warning ((,class (:foreground ,orange :background ,porcelain :weight bold :underline t))))
   `(font-lock-warning-face ((,class (:foreground ,orange :background ,porcelain :weight bold :underline t))))
   `(underline ((,class (:foreground ,jet :underline t))))))

(provide-theme 'yaru)

;;; yaru-theme.el ends here